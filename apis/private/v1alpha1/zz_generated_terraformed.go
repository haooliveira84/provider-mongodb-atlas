...
func (mg *EndpointRegionalMode) GetTerraformResourceType() string {
	return "mongodbatlas_private_endpoint_regional_mode"
}
...
// LateInitialize this EndpointRegionalMode using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *EndpointRegionalMode) LateInitialize(attrs []byte) (bool, error) {
	params := &EndpointRegionalModeParameters{}
