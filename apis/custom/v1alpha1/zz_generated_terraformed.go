...
func (mg *DNSConfigurationClusterAws) GetTerraformResourceType() string {
	return "mongodbatlas_custom_dns_configuration_cluster_aws"
}
...
// LateInitialize this DNSConfigurationClusterAws using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *DNSConfigurationClusterAws) LateInitialize(attrs []byte) (bool, error) {
	params := &DNSConfigurationClusterAwsParameters{}
