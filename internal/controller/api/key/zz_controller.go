...
import (
	...
	v1alpha1 "github.com/haooliveira84/provider-mongodbatlas/apis/api/v1alpha1"
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(tjcontroller.NewConnector(mgr.GetClient(), o.WorkspaceStore, o.SetupFn, o.Provider.Resources["mongodbatlas_api_key"], tjcontroller.WithLogger(o.Logger),
